...
MongoClient.connect(mongo_url, function(err, admin_db) {
  ...
  queue.process(concurrency, function(job, cb) 
  {
      ...
      uploadColorImage(db, {'from_site': from_site, 'show_product_id': p_id, 'color_flag': c_name, 'discard': {'$ne': '1'}}, from_site + "_" + p_id + "_" + c_name, cb);
      ...
      uploadColorImageAgain(db, {'from_site': from_site, 'show_product_id': p_id, 'color_flag': c_name, 'discard': {'$ne': '1'}}, from_site + "_" + p_id + "_" + c_name, cb);
